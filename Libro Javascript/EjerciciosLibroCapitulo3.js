/*Mínimo 
El capitulo anterior introdujo la función estándar Math.min que devuelve si argumento mas pequeño. Notros podemos construir algo como eso ahora.
Escribe una funcion min que tome dos argumentos y retorne su mínimo.*/
function min(a,b){
    if (a<b){
        return a;
    } else if (b<a){
